...
module.exports = {
  name: 'put',
  description: 'Put money to your safe',
  async execute(message, args) {
    ...
    if (!args[0]) {
      const errorEmbed = embeds.error('Invalid Amount', 'Please specify an amount to put');
      return message.channel.send({ embeds: [errorEmbed] });
    }
    ...
    message.channel.send(`You put **${economy.formatMoney(amount)}** coins to your safe.`);
  }
};
